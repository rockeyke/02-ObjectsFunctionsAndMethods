...
def main():
    ...
    # better_draw_circles((rg.Point(20, 100)), 20)
    # better_draw_circles((rg.Point(50, 50)), 10)

    # even_better_draw_circles((rg.Point(30, 100)), 6, 20, 'red', 2)
    # even_better_draw_circles((rg.Point(50, -200)), 7, 100, 'blue', 1)

    even_better_draw_circles((rg.Point(30, 100)), 50, 20, 'black', 50)
    even_better_draw_circles((rg.Point(35, 100)), 6, 20, 'red', 2)
    even_better_draw_circles((rg.Point(-45, -100)), 30, 20, 'white', 1)
    even_better_draw_circles((rg.Point(0, -70)), 10, 20, 'blue', 3)
    even_better_draw_circles((rg.Point(300, 300)), 10, 20, 'yellow', 5)
    even_better_draw_circles((rg.Point(-100, 300)), 3, 50, 'green', 1)
...
def even_better_draw_circles(point, radius, amount, color, thickness):
