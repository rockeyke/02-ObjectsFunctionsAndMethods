...
def try_methods():
    ...
    Then makes the SimpleTurtle move as follows (in the order listed):
      ...
      -- backward  100 units
    """
    stan = rg.SimpleTurtle()
    stan.pen = rg.Pen('brown', 5)
...
def try_methods_and_functions():
    ...
    """
    lee = rg.SimpleTurtle()
    lee.pen = rg.Pen('blue', 5)

    lee.backward(150)
    lee.speed = 1
    draw_many_squares(lee, 2, 100, 30)

    lee.speed = 5
    lee.pen.color = 'red'
    draw_many_squares(lee, 10, 50, 15)

    lee.speed = 100
    lee.pen.thickness = 35
    draw_many_squares(lee, 8, 300, 60)

    lee.pen = rg.Pen('black', 3)
    lee.backward(200)
    lee.draw_circle(30)
    lee.draw_square(50)
    ###########################################################################
